                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputFirstName" name="name" type="text" placeholder="Enter Resident's Name" />
                                    </div>
                                </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputFirstName">Username</label>
                                            <input class="form-control py-4" id="inputUserame" name="username" type="text" placeholder="Enter Resident's username" />
                                        </div>
                                    </div>
                                        <div class="form-group">
