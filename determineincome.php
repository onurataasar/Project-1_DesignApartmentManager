			...
			<div class="row profile">
				...
				<div class="col-md-9">
					<div class="profile-content">
						<h2>Determine Monthly Incomes</h2>
<br>
<?php
    include "check.php";

    if (isset($_POST['submit']) && !empty($_POST['income']) && !empty($_POST['incomename'])) {
      $income = $_POST['income'];
      $incomename = $_POST['incomename'];

      $sql = "INSERT INTO incomes (income, incomename) VALUES ('$income', '$incomename')";
    ...
    <form class="form-signin" role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);
      ...
      <table>
        ...
        <div class="textbox">
          <tr>
            <td>Income Name:(*):</td>
            <td><input type="text" name="incomename" value="" placeholder="Name of your income" size="50" required>
        ...
        <div class="textbox">
          <tr>
            <td>Income </td>
            <td><input type="int" name="income" value="" placeholder="Amount" size="50" required>
              <p style="color:red;display:inline;"></p>
            </td>
          </tr>
        </div>
